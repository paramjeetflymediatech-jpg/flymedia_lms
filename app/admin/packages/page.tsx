...
export default async function AdminPackagesPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  await requireAdmin();
  ...
  const packages = rows.map(c => c.toJSON());
