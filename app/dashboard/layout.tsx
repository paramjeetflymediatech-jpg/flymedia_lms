...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const getLinkClass = (path: string) => {
    ...
    return isActive
      ? "flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-orange-500 to-rose-500 text-white rounded-xl font-bold transition-colors shadow-sm"
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col hidden md:flex">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-2">
          ...
          <Link href="/dashboard/my-courses" className={getLinkClass('/dashboard/my-courses')}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
            My Courses
          </Link>
          <Link href="/dashboard/packages" className={getLinkClass('/dashboard/packages')}>
          ...
          <Link href="/dashboard/book-session" className={getLinkClass('/dashboard/book-session')}>
          ...
          <Link href="/dashboard/tutors" className={getLinkClass('/dashboard/tutors')}>
