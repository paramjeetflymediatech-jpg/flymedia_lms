...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const getLinkClass = (path: string) => {
    ...
    return isActive
      ? "flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-bold transition-colors shadow-sm"
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-2 flex flex-col">
          ...
          <div className="pt-6 mt-auto">
            <button 
              ...
              className="flex items-center gap-3 px-4 py-3 w-full text-left text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl font-semibold transition-colors border border-transparent hover:border-red-100"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header */}
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-10 z-10">
