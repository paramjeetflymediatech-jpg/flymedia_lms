          ...
          <div className="mt-10">
            ...
            <div className="mt-10 text-center space-y-6">
              ...
              <div className="pt-6 border-t border-slate-100">
                <Link href="/tutor/login" className="inline-flex items-center justify-center px-6 py-2.5 border-2 border-orange-100 text-sm font-bold text-orange-600 rounded-xl hover:bg-orange-50 hover:border-orange-200 transition-all">
                  Login as Tutor →
                </Link>
              </div>
            </div>
